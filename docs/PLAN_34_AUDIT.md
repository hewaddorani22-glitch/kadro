...
| 26 | Monetarisierung | Teilweise | Ein vollständiger Scan ist kostenlos; weitere Scans brauchen ein aktives `kandro_pro`-Entitlement. Monatsabo (7,99 €) und Jahresabo (49,99 €) sind in App Store Connect angelegt, in RevenueCat importiert, mit `kandro_pro` und dem Default-Offering verknüpft; beide Apple-Schlüssel und Server-Benachrichtigungen sind validiert. Vor der Einreichung bleiben nur nativer Sandbox-Kauf und Restore im TestFlight-Build zu prüfen. |
